...
COLORS = {
    'normal': '\033[0m',
    'ok': '\033[{0}m'.format(u'0;32'),
    'bold': '\033[1m',
    'not_so_bold': '\033[1m\033[34m',
    'changed': '\033[{0}m'.format(u'0;33'),
    'failed': '\033[{0}m'.format(u'0;31'),
    'endc': '\033[0m',
    'skipped': '\033[{0}m'.format(u'0;30'),
}
...
class CallbackModule(CallbackBase):
    """minifab.py callback plugin."""

    CALLBACK_VERSION = 2.0
    CALLBACK_TYPE = 'stdout'
    CALLBACK_NAME = 'minifab'
    ...
    def v2_playbook_on_stats(self, stats):
        ...
        for host in hosts:
            ...
            msg = '{0}: ok={1}\tfailed={2}\t'.format(host, s['ok'], s['failures'])
