...
# fabric.hyperledger.org/fabric-operator-bundle:$VERSION and fabric.hyperledger.org/fabric-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= fabric.hyperledger.org/fabric-operator
...
generate: ## Generate the yaml deployment file
	cd config/manager && $(KUSTOMIZE) edit set image controller=${IMG}
	$(KUSTOMIZE) build config/default > deploy/fabric_operator.yaml
